...
export default function AllUrlList({ sessionUrls }) {
  ...
  const UrlCard = ({ item }) => (
    <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-4 border border-gray-200 dark:border-gray-700 mb-4">
      ...
      <p className="text-sm text-gray-600 dark:text-gray-400">
        ...
        <a href={`/${item.code}`} target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline break-words">
